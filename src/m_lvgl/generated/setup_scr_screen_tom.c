...
void setup_scr_screen_tom(lv_ui *ui)
{
    ...
    lv_arc_set_value(ui->screen_tom_clockdown, 70);
    ...
    lv_obj_set_style_radius(ui->screen_tom_btn_back, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->screen_tom_btn_begin, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_tom_btn_subtract, 30, 121);
    ...
    lv_obj_set_style_radius(ui->screen_tom_btn_subtract, 15, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_tom_btn_plus, 250, 121);
    ...
    lv_obj_set_style_radius(ui->screen_tom_btn_plus, 15, LV_PART_MAIN|LV_STATE_DEFAULT);
